...
pub struct Kill {
    ...
    // Per-type first/last dates
    pub date_first_killed: Option<String>,
    pub date_first_slaughtered: Option<String>,
    pub date_first_vanquished: Option<String>,
    pub date_first_dispatched: Option<String>,
...
impl Kill {
    pub fn new(character_id: i64, creature_name: String, creature_value: i32) -> Self {
        Self {
            ...
            date_last: None,
            creature_value,
            date_first_killed: None,
            date_first_slaughtered: None,
            date_first_vanquished: None,
