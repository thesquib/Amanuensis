...
mod tests {
    ...
    fn test_get_or_create_character() {
        ...
        let id1 = db.get_or_create_character("Gandor").unwrap();
        let id2 = db.get_or_create_character("Gandor").unwrap();
    ...
    fn test_get_character() {
        let db = Database::open_in_memory().unwrap();
        db.get_or_create_character("Gandor").unwrap();
        let char = db.get_character("Gandor").unwrap().unwrap();
        assert_eq!(char.name, "Gandor");
